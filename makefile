...
compile-tests: testsuite.o test_card.o test_player.o test_game_rules.o test_pile.o test_last_move.o last_move.o pile.o test_game.o card.o player.o game.o game_rules.o
	$(CC) testsuite.o test_card.o test_player.o test_game_rules.o test_pile.o test_last_move.o test_game.o pile.o card.o player.o game.o game_rules.o last_move.o -I ~/include -L ~/lib -o testsuite -l headunit
